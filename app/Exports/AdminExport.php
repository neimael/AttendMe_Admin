...
class AdminExport implements FromQuery, WithHeadings, ShouldAutoSize, WithStyles, WithDrawings
{
    public function query()
    {
        // Customize this method to retrieve the data you want to export
        return Admin::query()->select('first_name', 'last_name', 'email', 'phone_number', 'avatar');
    }
    ...
    public function drawings()
    {
        ...
        foreach ($users as $index => $user) {
            $avatarPath = public_path('AdminAvatar/' . $user->avatar);
